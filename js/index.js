...
L.control.attribution({
	prefix: "<a href='https://www.facebook.com/lakluklakz/' target='_blank'>Facebook</a>"
}).addTo(map);
L.control.zoom({
	zoomInTitle: '+',
	zoomOutTitle: '-'
...
function onEachFeature(feature, layer) {
	...
	// popupHtml += '</div>';
	// popupHtml += '<div class="' + switchClass + '" onclick="MarkPoint(this)" data-key="' + key + '"><p class="switchOff">Undone</p><p class="switchOn">Done</p><div class="switchButton"><div class="switchButtonIcon"><p>Undone</p></div></div></div>';
...
function MarkPoint(element) {
	...
	if (newValue) {
		...
		setTimeout(function () {
			that.find(".switchButton p").html("Undone");
		}, 100);
	}
}
...
//定义筛选器项目
// var overlays = {
// 	"<span class='Layer_FST map-opts'>Phong Thần Đồng</span>": Layer_FST,
// 	"<span class='Layer_YST map-opts'>Nham Thần Đồng</span>": Layer_YST,
// 	"<span class='Layer_DLK_MD map-opts'>Mondstadt</span>": Layer_DLK_MD,
// 	"<span class='Layer_DLK_LY map-opts'>Liyue</span>": Layer_DLK_LY,
// 	"<span class='Layer_SJK_LY map-opts'>Pha Lê</span>": Layer_SJK_LY,
// 	"<span class='Layer_BTK_LY map-opts'>Sắt Trắng</span>": Layer_BTK_LY,
// 	"<span class='Layer_SJK_MD map-opts'>Pha Lê</span>": Layer_SJK_MD,
// 	"<span class='Layer_BTK_MD map-opts'>Sắt Trắng</span>": Layer_BTK_MD,
// 	"<span class='Layer_JYJJ map-opts'>Ớt Tuyệt Vân</span>": Layer_JYJJ,
// 	"<span class='Layer_NSH map-opts'>Hoa Nghê Thường</span>": Layer_NSH,
// 	"<span class='Layer_LLBH map-opts'>Bách Hợp Lưu Ly</span>": Layer_LLBH,
// 	"<span class='Layer_YPS map-opts'>Dạ Phách Thạch</span>": Layer_YPS,
// 	"<span class='Layer_SP map-opts'>Thạch Phách</span>": Layer_SP,
// 	"<span class='Layer_GGG map-opts'>Quả Móc Câu</span>": Layer_GGG,
// 	"<span class='Layer_DDL map-opts'>Hoa Calla Lilly</span>": Layer_DDL,
// 	"<span class='Layer_LLM map-opts'>Quả Dâu Đỏ</span>": Layer_LLM,
// 	"<span class='Layer_SXLYH map-opts'>Hoa Cecilia</span>": Layer_SXLYH,
// 	"<span class='Layer_MFMG map-opts'>Nấm Rơm Gió</span>": Layer_MFMG,
// 	"<span class='Layer_FCJ map-opts'>Cúc Cánh Quạt</span>": Layer_FCJ,
// 	"<span class='Layer_PGYZ map-opts'>Hạt Bồ Công Anh</span>": Layer_PGYZ,
// 	"<span class='Layer_YJSW_LY map-opts'>Thủ Vệ Di Tích</span>": Layer_YJSW_LY,
// 	"<span class='Layer_YJLZ_LY map-opts'>Thợ Săn Di Tích</span>": Layer_YJLZ_LY,
// 	"<span class='Layer_DXQQR_LY map-opts'>Bạo Đồ Hilichurl</span>": Layer_DXQQR_LY,
// 	"<span class='Layer_SYFS_LY map-opts'>Pháp Sư Vực Sâu</span>": Layer_SYFS_LY,
// 	"<span class='Layer_ZWCLR_LY map-opts'>Người Xử Lý Nợ</span>": Layer_ZWCLR_LY,
// 	"<span class='Layer_LYSS_LY map-opts'>Thuật Sĩ Cicin</span>": Layer_LYSS_LY,
// 	"<span class='Layer_BX_MD map-opts'>Rương Báu Vật—Mondstadt</span>": Layer_BX_MD,
// 	"<span class='Layer_BX_LY map-opts'>Rương Báu Vật—Liyue</span>": Layer_BX_LY,
// };
// //添加筛选器
...
map.on('popupopen', function (e) {
	...
	var switchText = (!markedFlag) ? "Undone" : "Done";
	popupHtml = `
