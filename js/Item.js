...
var overlays = {
    ...
    "<span class='DLK-OPT map-opts'>Mondstadt</span>": Layer_DLY_MD,
    "<span class='DLK-OPT map-opts'>Liyue</span>": Layer_DLY_LY,
    "<span class='KW-LY-OPT map-opts'>Pha Lê</span>": Layer_SJK_LY,
    "<span class='KW-LY-OPT map-opts'>Sắt Trắng</span>": Layer_BTK_LY,
    "<span class='KW-MD-OPT map-opts'>Pha Lê</span>": Layer_SJK_MD,
    "<span class='KW-MD-OPT map-opts'>Sắt Trắng</span>": Layer_BTK_MD,
    ...
    "<span class='CJW-OPT map-opts'>Dạ Phách Thạch</span>": Layer_YPS,
    "<span class='CJW-OPT map-opts'>Thạch Phách</span>": Layer_SP,
    "<span class='CJW-MD-OPT map-opts'>Quả Móc Câu</span>": Layer_GGG,
    "<span class='CJW-MD-OPT map-opts'>Hoa Calla Lilly</span>": Layer_DDL,
    ...
    "<span class='JYG-LY-OPT map-opts'>Thợ Săn Di Tích</span>": Layer_YJLZ_LY,
    "<span class='JYG-LY-OPT map-opts'>Bạo Đồ Hilichurl</span>": Layer_DXQQR_LY,
    "<span class='JYG-LY-OPT map-opts'>Pháp Sư Vực Sâu</span>": Layer_SYFS_LY,
    "<span class='JYG-LY-OPT map-opts'>Người Xử Lý Nợ</span>": Layer_ZWCLR_LY,
    "<span class='JYG-LY-OPT map-opts'>Thuật Sĩ Cicin</span>": Layer_LYSS_LY,
};

L.control.layers(null, overlays).addTo(map);
$(".leaflet-control-layers-overlays label").eq(0).before('<a class="ST-OPT assortType">神瞳</a>');
$(".leaflet-control-layers-overlays label").eq(2).before('<a class="DLK-OPT assortType">Đền</a>');
$(".leaflet-control-layers-overlays label").eq(4).before('<a class="KW-LY-OPT assortType">Khoáng Sản——Liyue</a>');
$(".leaflet-control-layers-overlays label").eq(6).before('<a class="KW-MD-OPT assortType">Khoáng Sản——Mondstadt</a>');
$(".leaflet-control-layers-overlays label").eq(8).before('<a class="CJW-OPT assortType">采集物——Liyue</a>');
$(".leaflet-control-layers-overlays label").eq(13).before('<a class="CJW-MD-OPT assortType">采集物——Mondstadt</a>');
$(".leaflet-control-layers-overlays label").eq(20).before('<a class="JYG-LY-OPT assortType">精英怪——Liyue</a>');
